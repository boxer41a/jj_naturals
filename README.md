# jj_naturals
This repository is built on the idea that the Eiffel Software NATURAL\_xxx classes should have a common ancestor, allowing those NATURAL\_xxx classes to be used in a generic context.  This library provides that genericity by inserting class [JJ_NATURAL](./jj_override/jj_natural.e) between NUMERIC and all the NATURAL\_xx\_REF classes.
...
_I understand that theoretically some NUMERIC types (e.g. imaginary numbers) are NOT comparable, but for practical usage, I think bending that rule would be better._
